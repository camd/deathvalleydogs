...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('data_trip', 'map_points', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Hike.map_points'
        db.alter_column('data_hike', 'map_points', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Trip.map_points'
        db.alter_column('data_trip', 'map_points', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Hike.map_points'
        db.alter_column('data_hike', 'map_points', self.gf('django.db.models.fields.TextField')(default=''))
