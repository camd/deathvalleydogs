...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TripWriteup.hike'
        db.add_column('data_tripwriteup', 'hike', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.Hike'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TripWriteup.hike'
        db.delete_column('data_tripwriteup', 'hike_id')
